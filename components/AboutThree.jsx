          ...
          <div className="col-xl-7 text-xl-center">
            <div className="about-thumb3 mb-40 mb-xl-0">
              <div className="about-img-1">
                <img src="assets/img/normal/wcu-3.png" alt="İberAuto" />
              </div>
            </div>
          </div>
          <div className="col-xl-5">
            <div className="about-content-wrap">
              <div className="title-area me-xl-5 mb-30">
                ...
                <h2 className="sec-title">Ən Yaxşı Üstünlüklərimiz</h2>
                  ...
                  <div className="checklist style2">
                    <ul>
                      <li>
                        ...
                        Aşağı Qiymət Zəmanəti
                      </li>
                      <li>
                        <i className="fas fa-check-double" />
                        Təlimli Texniki Mütəxəssislər
                      </li>
                      <li>
                        <i className="fas fa-check-double" />
                        Ömürlük Zəmanət
                      ...
                      <li>
                        <i className="fas fa-check-double" />
                        Avtomatlaşdırılmış test xətləri
                      </li>
                    </ul>
                  </div>
                </div>
