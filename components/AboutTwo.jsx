            ...
            <div className="about-content-wrap">
              <div className="title-area mb-30">
                ...
                <h2 className="sec-title">
                  Avtomobil Parçalarında Etibarlı Tərəfdaş{" "}
                  <img
                ...
                <p className="sec-text">
                  IberAuto olaraq, bütün marka və modellər üçün orijinal və keyfiyyətli avtomobil parçaları təqdim edirik. 15 ildən artıq təcrübəmizlə, müştərilərimizə ən yaxşı məhsulları və xidməti təqdim etməyə çalışırıq. Geniş məhsul çeşidimiz və sürətli çatdırılma xidmətimizlə ehtiyacınız olan bütün avtomobil parçalarını tapa bilərsiniz.
                </p>
              </div>
              <div className="about-feature-wrap style-shadow">
                ...
                <div className="about-feature-wrap-details">
                  ...
                  <p className="about-feature-text">
                    Bütün marka və modellər üçün orijinal və keyfiyyətli avtomobil parçaları təqdim edirik.
                  </p>
                </div>
              </div>
              <div className="about-feature-wrap style-shadow">
